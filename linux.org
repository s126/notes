...
#+BEGIN_SRC sh
  ...
  # 设置 JAVA_HOME
  echo "JAVA_HOME=/opt/jdk1.8.0_121" >> .bashrc

  # 设置 path
  sudo update-alternates --install /usr/bin/java java /opt/jdk1.8.0_121/bin/java 2222
  sudo update-alternates --install /usr/bin/javac javac /opt/jdk1.8.0_121/bin/javac 2222
  sudo update-alternates --install /usr/bin/javap javap /opt/jdk1.8.0_121/bin/javap 2222
  
  # 然后，可以通过下面命令切换版本
  sudo update-alternates --config java
  sudo update-alternates --config javac
#+END_SRC
