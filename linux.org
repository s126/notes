...
#+BEGIN_SRC sh
  ...
  # 设置 path
  sudo update-alternatives --install /usr/bin/java java /opt/jdk1.8.0_121/bin/java 2222
  sudo update-alternatives --install /usr/bin/javac javac /opt/jdk1.8.0_121/bin/javac 2222
  sudo update-alternatives --install /usr/bin/javap javap /opt/jdk1.8.0_121/bin/javap 2222
